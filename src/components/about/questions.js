      ...
      <div className={styles.rowWrapper}>
        <div className={styles.row}>
          ...
          <div className={styles.cardOuter}>
              <Link to="https://music.apple.com/ca/album/ruins/1298785869"><div className={styles.card}>
          ...
          <div className={styles.cardOuter}>
            <Link to="https://www.intercom.com/blog/podcasts/"><div className={styles.card}>
          ...
          <div className={styles.cardOuter}>
            <Link to="https://music.apple.com/ca/album/broken-machine-deluxe/1226033753"><div className={styles.card}>
          ...
          <div className={styles.cardOuter}>
            <Link to="https://www.pushkin.fm/show/revisionist-history/"><div className={styles.card}>
        ...
        <div className={styles.row}>
          ...
          <div className={styles.cardOuter}>
            <Link to="https://www.chapters.indigo.ca/en-ca/books/alive-at-work-the-neuroscience/9781633697669-item.html?ikwid=alive+at+work&ikwsec=Home&ikwidx=0#algoliaQueryId=ca832de5303c004dd9ced479bbe397d2"><div className={styles.card}>
          ...
          <div className={styles.cardOuter}>
            <Link to="https://www.chapters.indigo.ca/en-ca/books/escaping-the-build-trap-how/9781491973790-item.html?ikwid=escaping+the+build+trap&ikwsec=Home&ikwidx=0#algoliaQueryId=22f37524c6b23305b353478227dc1665"><div className={styles.card}>
          ...
          <div className={styles.cardOuter}>
            <Link to="https://www.chapters.indigo.ca/en-ca/books/inspired-how-to-create-tech/9781119387503-item.html?ikwid=inspired&ikwsec=Home&ikwidx=36#algoliaQueryId=84be30dd91bc9b1d2d2b7a3a094d8da8"><div className={styles.card}>
          ...
          <div className={styles.cardOuter}>
            <Link to="https://www.chapters.indigo.ca/en-ca/books/technically-wrong-sexist-apps-biased/9780393356045-item.html?ikwid=technically+wrong&ikwsec=Home&ikwidx=0#algoliaQueryId=dedce57c7732c218faceecb213787b42"><div className={styles.card}>
        ...
        <div className={styles.row}>
          ...
          <div className={styles.cardOuter}>
            <Link to="https://www.foodnetwork.com/shows/diners-drive-ins-and-dives"><div className={styles.card}>
          ...
          <div className={styles.cardOuter}>
            <Link to="https://www.cbc.ca/schittscreek/"><div className={styles.card}>
          ...
          <div className={styles.cardOuter}>
            <Link to="https://tv.apple.com/ca/show/ted-lasso/umc.cmc.vtoh0mn0xn7t3c643xqonfzy"><div className={styles.card}>
